...
const Contact: React.FC = () => {
  ...
  const copy = isEnglish
    ? {
        ...
        seoDescription:
          'Contact Cyber Guide for questions about analyses, templates, and operational tooling.',
        ...
        subjectProject: 'Project proposal for Cyber Guide',
    ...
    : {
        seoTitle: 'Contact Cyber Guide',
        seoDescription:
          'Contactez Cyber Guide pour une question sur les analyses, templates ou outils opérationnels.',
        headerSubtitle: 'Communication',
        ...
        subjectProject: 'Proposition de projet pour Cyber Guide',
  ...
  const isProjectProposalPrefill = new URLSearchParams(location.search).get('topic') === 'project';
  const projectMessageTemplate = isEnglish
    ? [
        'Hello Cyber Guide team,',
        '',
        'I would like to propose an operational project for publication.',
        '',
        'Project title:',
        'Operational context:',
        'Documented impact (before/after):',
        'Official sources (URLs):',
        'Reusable takeaways for other organizations:',
      ].join('\n')
    : [
        "Bonjour l'équipe Cyber Guide,",
        '',
        'Je souhaite proposer un projet opérationnel pour publication.',
        '',
        'Titre du projet :',
        'Contexte opérationnel :',
        'Impact documenté (avant/après) :',
        'Sources officielles (URL) :',
        "Enseignements réutilisables pour d'autres organisations :",
      ].join('\n');
  ...
  const [formData, setFormData] = useState({
    ...
    name: '',
    email: '',
    subject: isProjectProposalPrefill ? copy.subjectProject : '',
    message: isProjectProposalPrefill ? projectMessageTemplate : '',
    honeypot: '',
  });
                  ...
                  <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                    ...
                    <div>
                      ...
                      >
                        ...
                        <option value={copy.subjectProject}>{copy.subjectProject}</option>
