...
const HOME_GUIDES: Record<SupportedLocale, HomeGuideCard[]> = {
  fr: [
    {
      slug: 'securite-active-directory',
      title: 'Guide Sécurité Active Directory',
      excerpt:
        'Plan défensif concret pour réduire les mouvements latéraux, protéger le Tier 0 et renforcer la résilience AD.',
      category: 'Identité & Infrastructure',
    },
    {
      slug: 'reponse-ransomware-pme',
      title: 'Guide Réponse Ransomware PME',
      excerpt:
        'Préparation et réponse pour réduire le temps de crise, protéger les sauvegardes et reprendre plus vite.',
    ...
    },
    {
      ...
      excerpt:
        'Feuille de route pragmatique pour aligner gouvernance, gestion des risques et obligations de notification.',
  ...
  en: [
    {
      ...
      excerpt:
        'Concrete defensive plan to reduce lateral movement, protect Tier 0, and improve AD resilience.',
    ...
    },
    {
      ...
      excerpt:
        'Preparation and response to reduce crisis time, protect backups, and restore operations faster.',
    ...
    },
    {
      ...
      excerpt:
        'Pragmatic roadmap to align governance, risk management, and incident notification obligations.',
      category: 'Governance & Compliance',
    },
  ],
};

const getHomeGuides = (locale: SupportedLocale): HomeGuideCard[] => HOME_GUIDES[locale];
...
const Home: React.FC = () => {
  ...
  const isEnglish = locale === 'en';
  const guides = React.useMemo(() => getHomeGuides(locale), [locale]);
  ...
  const copy = isEnglish
    ? {
        ...
        seoDescription:
          'Cyber Guide centralizes analyses, templates, and operational tooling to structure cybersecurity execution for organizations.',
        inLanguage: 'en-US',
        ...
        chips: ['Operational', 'Actionable guides', 'Source-based'],
        ...
        strategicFiles: 'Strategic analysis',
        openDossier: 'OPEN DOSSIER',
        viewAllDossiers: 'View all analysis',
    ...
    : {
        ...
        seoDescription:
          'Cyber Guide centralise analyses, templates et outils opérationnels pour structurer la cybersécurité des organisations françaises.',
        inLanguage: 'fr-FR',
        ...
        chips: ['Opérationnel', 'Guides actionnables', 'Sourcé'],
            ...
            <div className="lg:col-span-7">
              <BlueprintPanel title={copy.quickAssistantTitle} label="IR_15_MIN">
                ...
                <div className="rounded-sm border border-slate-200 bg-slate-50 p-4">
                  <p className="text-lg font-display font-bold text-brand-navy">{selectedPlan.title}</p>
